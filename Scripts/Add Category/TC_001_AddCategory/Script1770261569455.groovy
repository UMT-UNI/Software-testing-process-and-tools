...
WebUI.click(findTestObject('Object Repository/TC Product/Page_/td_admingmail.com'))
...
WebUI.setText(findTestObject('Object Repository/TC Product/Page_Add Category/input__category_name'), 'Đồ uống')
