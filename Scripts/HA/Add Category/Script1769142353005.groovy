...
WebUI.setText(findTestObject('Object Repository/TC Product/Page_Login/input_Email_email_1'), 'admin@gmail.com')

WebUI.setEncryptedText(findTestObject('Object Repository/TC Product/Page_Login/input_Password_password_1'), 'aeHFOx8jV/A=')
